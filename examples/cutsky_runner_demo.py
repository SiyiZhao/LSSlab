...
def main() -> None:
    ...
    runner = CutskyRunner(
        ...
        boxL=2000.0,
        nz_path_random={"N": workdir / "QSO_NGC_nz_times_10.txt", "S": workdir / "QSO_SGC_nz_times_10.txt"},
        boxL_random=6000.0,
    )
    ...
    box_path = runner.prepare_random_box(num=3.1e8, seed=4242)
    random_cases[0]["box_path"] = box_path
    runner.generate_random(random_cases, nz_path={"N": workdir / "QSO_NGC_nz_times_10.txt"})
    
    random_cases[0]["box_path"] = runner.prepare_random_box(num=2.4e8, seed=34242)
    runner.generate_random(random_cases, nz_path={"S": workdir / "QSO_SGC_nz_times_10.txt"})
